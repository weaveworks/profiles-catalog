...
app.kubernetes.io/name: {{ include "external-secrets-config.chart" . }}
app.kubernetes.io/instance: {{ include "external-secrets-config.chart" . }}
app.kubernetes.io/part-of: {{ include "external-secrets-config.chart" . }}
{{- if .Chart.AppVersion }}
